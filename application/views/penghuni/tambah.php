...
<div class="col-md-12">        
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">            
            <?php echo form_open('penghuni/insert',array('class'=>'form-horizontal form-groups-bordered','blok'=>'form'));  ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="nama_pemilik" id="nama_pemilik" class="form-control" placeholder="Nama Pemilik" readonly=true required>
                        <br>
                        <textarea name="alamat_lengkap" id="alamat_lengkap" class="form-control" placeholder="Alamat Lengkap" readonly=true required></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nama_penghuni" id="nama_penghuni" placeholder="Nama Penghuni" required/>
                    </div>
                </div>
